...
/// Base64-encoded X25519 identity public key (`xidentity` field).
pub const XIDENTITY_B64: &str = "gLf/SYoOb5WarU8n+c06igQDMavLP1W6mjKvdEuOq0M=";
...
mod tests {
    ...
    fn canonical_vectors_match_golden() {
        ...
        assert_eq!(entity.xidentity, XIDENTITY_B64);
