...
% 使用 resizebox 确保图表自动缩放以适应页面宽度
  ...
  \[
   ...
   \text{Ed25519 keys},\,
   \text{Secp256k1 keys},\,
   \text{X25519 DH keys (xIdentity/xID)},\,
   \ldots
   \}.
  \]
  ...
  \begin{enumerate}
   ...
   The system derives a deterministic X25519-based xIdentity to serve as a
  ...
  \paragraph{xIdentity (xID).}
  The derived X25519 key pair serves as the deterministic \emph{xIdentity} (xID) of the Crypto Entity.
